...
local function chunk_refining_recipe_updater(
  ore_name,
  refining_result,
  result_amount,
  refining_liquid,
...
chunk_refining_recipe_updater("copper-ore", "copper-ore", 60, sulfuricacidname, 100)
chunk_refining_recipe_updater("coal", "coal", 40, sulfuricacidname, 100)
chunk_refining_recipe_updater("stone", "stone", 40, sulfuricacidname, 100)
chunk_refining_recipe_updater("uranium-ore", "uranium-ore", 16, sulfuricacidname, 1000)
